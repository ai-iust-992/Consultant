...
urlpatterns = [
    ...
    path('request/', views.AnswerToRequestAPI.as_view(), name="get all requests"),
    path('request/<int:requestId>/', views.AnswerToRequestAPI.as_view(), name="answer to requests"),
